...
import { balanceOf, checkAllowance, approveERC20 } from '../utils/erc20';
import { getQuote } from '../api';

const sellToken = '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984'; // UNI
const buyToken = '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6'; // ETH
...
export default function UNITOETH({ account }) {
  ...
  const handleSwap = async () => {
    try {
      ...
      const allowanceAmount = await checkAllowance(sellTokenAddress, CONTRACT_ADDRESS, account, parsedSellAmount);
      if (!allowanceAmount) {
        await approveERC20(sellTokenAddress, CONTRACT_ADDRESS);
      }

      console.log({ sellTokenAddress, buyTokenAddress, sellAmount: parsedSellAmount, allowanceTarget, to, data: swapData });
  ...
  return (
    <div className="converter_holder">
      <div className="panel left second">
      ...
      <div className="panel right second">
        <div className="content">
